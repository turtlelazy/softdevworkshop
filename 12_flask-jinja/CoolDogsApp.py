...
names = ["Ishraq & Fish", "Gavin & Craig", "Ivan & Bob"]

@app.route("/cooldogsonly") #Q1: Can all of your teammates confidently predict the URL to use to load this page?
#Yes. We've realized that this keyword specifies the directory, with root being at /
def test_tmplt():
    return render_template( 'model_tmplt.html', foo="fooooo", names=names) #Q2: What is the significance of each argument?
